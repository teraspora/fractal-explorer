...
There still remain some issues
...
This is compounded by the fact that Chrome and Firefox lay out my control panel a little differently.   The `<input>` elements in the button divs are too wide in Firefox.
